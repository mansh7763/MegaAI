...
This project was built with AI assistance (Cursor). The AI was used for:
...
All architectural decisions (SharedContext schema, ContextBudgetManager, multi-hop citation enforcement, eval scoring logic) were designed by me(Himanshu) and implemented with AI assistance.
